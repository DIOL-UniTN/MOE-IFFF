...
from utils.nn import train_epoch, eval_model, eval_model

class TrainFFF(BaseExp):
    def __init__(self, n_runs: int):
        super().__init__()  # Initialize BaseExp
        self.exp_name = "TrainingFFF"
        self.n_runs = n_runs
    ...
    def setup(self, partial_model, loader, optim, a_sched: Optional[object], device, mconf: object, proj_name: str, 
    ...
    def run_exp_single(self, epochs):
        ...
        # Testing
        test_loss, test_acc = eval_model(self.model, self.loader.test, 
